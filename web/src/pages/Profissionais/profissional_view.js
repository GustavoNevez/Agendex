import { Button, Icon, InputGroup, Input, Tag } from 'rsuite';
    ...
    return (
        <div className="col p-4 overflow-auto h-100" style={{ animation: 'fadeIn 0.3s ease-in-out' }}>
            ...
            <CustomDrawer
                ...
                title={comportamento === "create" ? "Cadastrar profissional" : "Atualizar profissional"}
                size="md"
                ...
                secondaryActionLabel={comportamento === "update" ? "Remover Profissional" : undefined}
                secondaryActionColor="red"
                onSecondaryAction={comportamento === "update" ? () => selecionarComponente('confirmDelete', true) : undefined}
                ...
                <div className="row mt-2">
                    ...
                    <div className="form-group col-12 mb-3">
                        ...
                        <small className="text-muted mt-1 d-block">
                            <Icon icon="info-circle" /> Este link permitirá que clientes acessem diretamente o perfil
                        </small>
                    </div>
                </div>
            </CustomDrawer>
