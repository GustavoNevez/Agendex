...
import AppointmentCard from "../../../components/AppointmentCard/card_appointment";
...
const StepAuthAndReservations = ({ customLink, publicData }) => {
  ...
  const { clientRegistration, clientAppointments } = useSelector(
    (state) => state.public
  );
  ...
  const handleCancelReservation = async () => {
    ...
    try {
      await dispatch(
        deleteClientAppointment({ customLink, id: selectedReservation.id })
      );
      setShowReservationModal(false);
    } catch (err) {
    ...
    return (
      <div className="bg-gray-50 min-h-full p-4 lg:flex lg:justify-center">
        <div className="space-y-6 w-full max-w-2xl">
          <h2 className="text-2xl font-bold text-violet-700 mb-2 text-left">
            Meus Agendamentos
          </h2>
          ...
          {selectedReservation && (
            <CustomDrawer
              ...
              primaryActionDisabled={
                canceling || selectedReservation?.status === "cancelado"
              }
              ...
              <div className="space-y-6 ">
                <div>
                  ...
                  <span className="font-semibold text-gray-800 text-lg">
                    {selectedReservation.servicoNome ||
                      selectedReservation.servico ||
                      ""}
                  </span>
                </div>
                <div>
                  ...
                  <span className="font-semibold text-gray-800 text-lg">
                    {selectedReservation.profissionalNome ||
                      selectedReservation.profissional ||
                      ""}
                  </span>
                </div>
                  ...
                  <div>
                    ...
                    <span className="font-semibold text-violet-700 text-lg">
                      {selectedReservation.horario ||
                        moment(selectedReservation.data).format("HH:mm")}
                    </span>
                  </div>
                </div>
                <div>
                  ...
                  <span className="font-semibold text-orange-600 text-xl">
                    R${" "}
                    {typeof selectedReservation.valor === "number"
                ...
                <div>
                  ...
                  <span
                    className={`inline-block font-bold px-3 py-1 rounded-full text-sm
                                            ${
