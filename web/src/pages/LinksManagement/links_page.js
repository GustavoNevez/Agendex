...
import { allProfissionais } from '../../store/modules/profissional/actions';
...
const LinksManagement = () => {
    ...
    const { profissionais } = useSelector(state => state.profissional) || { profissionais: [] };
    ...
    const fetchEstabelecimentoInfo = async () => {
        try {
            ...
            showErrorToast("Não foi possível carregar as informações do estabelecimento");
        } finally {
            setLoading(false);
        }
    };
    ...
    const handleSaveEstabelecimentoLink = async () => {
        try {
            ...
            if (!data.error) {
                showSuccessToast("Link personalizado do estabelecimento atualizado com sucesso!");
            ...
            if (error.response) {
                ...
                if (error.response.status === 401) {
                    ...
                    showErrorToast(`Erro ${error.response.status}: ${error.response.data?.message || "Não foi possível salvar o link"}`);
                }
            } else {
                showErrorToast("Não foi possível salvar o link personalizado: " + error.message);
            }
        } finally {
            setLoading(false);
        }
    ...
    const handleSaveProfissionalLink = async () => {
        ...
        try {
            ...
            console.log("Tentando salvar profissional com ID:", selectedProfissional.id);
            console.log("Link personalizado do profissional:", selectedProfissional.customLink);
            ...
            if (!data.error) {
                showSuccessToast("Link personalizado do profissional atualizado com sucesso!");
            ...
            console.error("Erro ao salvar link personalizado do profissional:", error);
            if (error.response) {
                console.error("Status:", error.response.status);
                console.error("Dados:", error.response.data);
    ...
    const copyToClipboard = (text) => {
        navigator.clipboard.writeText(text)
            .then(() => showSuccessToast("Link copiado para a área de transferência!"))
    ...
    return (
        <div className="p-4 overflow-auto h-100" style={{ animation: 'fadeIn 0.5s ease-in-out' }}>
            <div className="grid grid-cols-1 gap-6 md:px-80 mb-20">
                <div className="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-100" style={{ animation: 'fadeIn 0.3s ease-in-out' }}>
                    <div className="  p-4  ">
                        ...
                        <p className="text-gray-600 mb-5">
                            Crie links personalizados para seu estabelecimento e profissionais, facilitando o acesso
                            dos seus clientes ao sistema de agendamento.
                        </p>

                        <div className="bg-indigo-50 p-4 rounded-xl mb-6 border border-indigo-100">
                            <h3 className="font-semibold text-lg mb-4 text-indigo-800">Link do Estabelecimento</h3>
                                ...
                                <div className="flex-1">
                                    {estabelecimento.customLink ? (
                                        <div>
                                            ...
                                            <div className="flex items-center flex-wrap bg-white p-2 rounded-lg border border-indigo-100 shadow-sm">
                                                ...
                                                <button
                                                    ...
                                                    onClick={() => copyToClipboard(`http://localhost:3001/public/e/${estabelecimento.customLink}`)}
                                                >
                                                    <Icon icon="copy" />
                                                </button>
                                            </div>
                                        ...
                                        <p className="text-gray-600 bg-white p-4 rounded-lg border border-indigo-100">
                                            Você ainda não configurou um link personalizado para seu estabelecimento.
                                        </p>
                                    )}
                                </div>
                                <Button
                        ...
                        <h3 className="font-bold text-gray-800 text-2xl mb-3">Links dos Profissionais</h3>
                        
                        {/* Mobile and Desktop Card Layout for Professionals */}
                        <div className="space-y-4">
                            {loading ? (
                                <div className="text-center p-8 bg-gray-50 rounded-lg">
                                    <Icon icon="spinner" spin size="2x" className="text-indigo-500 mb-3" />
                                ...
                                <div className="text-center p-8 bg-gray-50 rounded-lg">
                                    ...
                                    <p className="mt-4 text-gray-500 font-medium">Nenhum profissional cadastrado.</p>
                                </div>
                            ) : (
                                        ...
                                        <div className="p-4">
                                            <div className="flex flex-col md:flex-row md:items-center gap-4">
                                                <div className="flex items-center">
                                                    ...
                                                    <div className="ml-4">
                                                        <div className="font-medium text-lg text-gray-900">{profissional.nome}</div>
                                                ...
                                                <div className="md:ml-auto flex-1 mt-3 md:mt-0">
                                                    <div className="bg-gray-50 p-3 rounded-lg border border-gray-100">
                                                        <p className="text-sm font-medium text-gray-500 mb-2">Link Personalizado:</p>
                                                        {profissional.customLink ? (
                                                            <div className="flex items-center flex-wrap">
                                                                ...
                                                                <button
                                                                    ...
                                                                    onClick={() => copyToClipboard(`http://localhost:3001/public/p/${profissional.customLink}`)}
                                                                >
                                                                    <Icon icon="copy" />
                                                                </button>
                                                            </div>
                                                        ) : (
                                                            <span className="text-gray-400 block py-2">Não definido</span>
                                                        )}
                                                    </div>
                                                </div>
                                                ...
                                                <div className="mt-3 md:mt-0">
                                                    <Button
                                                        appearance="primary"
                                                        size="sm"
                                                        onClick={() => handleOpenProfissionalModal({ ...profissional })}
                                                        style={{
                                                            background: profissional.customLink ? 'linear-gradient(45deg, #3b82f6, #60a5fa)' : 'linear-gradient(45deg, #4f46e5, #7c3aed)',
                                                    ...
                                                    >
                                                        {profissional.customLink ? "Editar Link" : "Criar Link"}
                                                    </Button>
                                                </div>
                                            </div>
                                        </div>
            ...
            >
                <div>
                    <div className="form-group">
                        <label className="block text-gray-700 font-medium mb-2">Link Personalizado</label>
                        ...
                        <small className="text-gray-500 mt-2 block">
                            Use apenas letras, números e hífens. Este link será usado para acessar a página de agendamentos do seu estabelecimento.
                        </small>
                    </div>

                    {estabelecimento.customLink && (
                        <div className="mt-5">
                            <p className="text-gray-700 font-medium mb-2"><b>URL completa:</b></p>
                        ...
                        <div className="form-group">
                            ...
                            <div className="flex items-center overflow-hidden rounded-lg border border-gray-200 bg-white">
                                ...
                                <input
                                    ...
                                    onChange={(e) => setSelectedProfissional({
                                        ...selectedProfissional,
                                        customLink: validateCustomLink(e.target.value)
                                    })}
                                />
                            ...
                            <small className="text-gray-500 mt-2 block">
                                Use apenas letras, números e hífens. Este link será usado para acessar a página de agendamentos deste profissional.
                            </small>
                        </div>
